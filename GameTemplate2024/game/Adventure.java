...
@SuppressWarnings({"EnhancedSwitchMigration", "ForLoopReplaceableByForEach"})
public class Adventure {
    ...
    public static void pokeObject(int objectNum, int currentRoom, boolean torchLit) {
        ...
        if (objectNum == NOT_FOUND) {
            ...
            if (isItemInRoom(objectNum, currentRoom)) {
                if (objectNum == KEY) {
                    ...
                    if (torchLit == true) {
                      System.out.printf("AHHHHHHHHHHHHHHHHHHHHH!!!\n");
                      return false;
                      }
                    else{
